<script lang="ts">
	...
	import type { Category } from '$lib/client/shopping/schema';
...
>
	...
	<Listgroup active>
			...
			>
				{#each categories as category (category.id)}
					<div animate:flip={{ duration: dropZoneOptions.flipDurationMs }}>
						<ListgroupItem
							href={resolve('/shopping/webapp/settings/category/[[categoryId=uuid]]', {
		...
		<ListgroupItem
			...
			href={resolve('/shopping/webapp/settings/category')}
		>
