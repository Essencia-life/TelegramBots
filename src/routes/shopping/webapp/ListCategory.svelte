<script lang="ts">
	...
	import { fractionMapping } from '$lib/client/shopping/utils';
	import type { Category, Item } from '$lib/client/shopping/schema';
	import { getCollapsedCategories, toggleCategory } from '$lib/client/shopping/cloudStorage.svelte';
...
<section class="last-of-type:mb-4">
		...
		<div transition:slide>
			<Listgroup active>
				...
				<ListgroupItem
					...
					href={resolve('/shopping/webapp/item/[categoryId=uuid]', { categoryId: category.id })}
...
{#snippet listItem(item: Item)}
	<ListgroupItem class="h-10 items-center py-0 pr-1">
		...
		<a
			...
			href={resolve('/shopping/webapp/item/[categoryId=uuid]/[[itemId=uuid]]', {
