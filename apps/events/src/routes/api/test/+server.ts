...
export const GET: RequestHandler = async () => {
    try {
        const response = await calendar.insertEvent({
            ...
            status: 'tentative', // not yet approved / payed
            visibility: 'private',
            transparency: 'opaque',
            source: {
            ...
            attendees: [
                ...
                { displayName: 'Benjamin Buhler', email: 'frufti@gmail.com', comment: 'Organizer', responseStatus: 'tentative' }  // not yet approved / payed
            ],
            attachments: [
